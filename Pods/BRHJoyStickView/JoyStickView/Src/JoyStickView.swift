...
@IBDesignable public final class JoyStickView: UIView {
    ...
    private var radius: CGFloat { return bounds.size.width / 2.0 * travel }
...
extension JoyStickView {
    ...
    private func reportPosition() {
        ...
        switch monitor {
        case let .polar(monitor): monitor(JoyStickViewPolarReport(angle: angle, displacement: displacement))
    ...
    private func repositionBase(location: CGPoint, angle: CGFloat) -> Bool {
        ...
        center = baseCenterClamper(desiredCenter)
